...
function load_model() {
    ...
    r.open("GET", "loadmodel.php?m=" + brand, true);
    r.send();
...
function updateProduct() {
    ...
    var delivery_within_colombo = document.getElementById("dfc");
    var delivery_outof_colombo = document.getElementById("dfo");
    ...
    f.append("dfc", delivery_within_colombo.value);
    f.append("dfo", delivery_outof_colombo.value);
...
function deleteFromCart(id) {
    ...
    r.onreadystatechange = function () {
        ...
        if (r.readyState == 4) {
            var t = r.responseText;
            if (t == "success") {
                alert("product removw from cart");
                window.location.reload();
            } else {
                alert(t);
            }
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == "1") {
                ...
                var payment = {
                    "sandbox": true,
                    "merchant_id": "1221219",    // Replace your Merchant ID
...
function manegerVarification() {
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            var t = r.responseText;
            if (t == "Success") {
                var adminVarificationModel = document.getElementById("varificationModel");
                av = new bootstrap.Modal(adminVarificationModel);
                av.show();
    ...
    r.open("POST", "manegerVerificationprocces.php", true);
    r.send(f);
}
...
function verify() {
    ...
    r.open("GET", "manegeremailVerify.php?v=" + verification.value, true);
    r.send();
}
...
function verifyCategory() {
    var ncm = document.getElementById("addCategoryVarificationModal");
...
function changeInvoiceStatus(id) {
    ...
    r.open("GET", "changeStatusInvoiceProcess.php?id=" + id, true);
    r.send();
}
...
function sendAdminMsg() {
    ...
    r.open("POST", "sendAdminMassageProcess.php", true);
    r.send(f);
