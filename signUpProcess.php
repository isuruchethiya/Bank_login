...
if (empty($fname)) {
    ...
    (`fname`,`lname`,`email`,`mobile`,`password`,`gender_id`,`joined_date`,`status`,`verificaton_coad`) VALUES 
    ('" . $fname . "','" . $lname . "','" . $email . "','" . $mobile . "','" . $password . "','" . $gender . "',NOW(),'1','".$verification_Code."')");
